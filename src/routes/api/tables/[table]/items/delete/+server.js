/**
 * API endpoint para eliminar items DynamoDB
 * POST /api/tables/[table]/items/delete
 */
...
export async function POST({ params, request, cookies }) {
	try {
		...
		const { connectionId, key } = requestBody;
		...
		const result = await service.deleteItem(tableName, key);
